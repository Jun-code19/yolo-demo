...
<template>
  ...
  <el-container v-else class="layout-container">
    <el-aside :width="isCollapse ? '64px' : '240px'" class="transition-width">
      ...
      <el-menu :default-active="route.path" class="el-menu-vertical" :router="true" background-color="#1e293b"
        text-color="#94a3b8" active-text-color="#ffffff" :collapse="isCollapse">
        <el-menu-item index="/">
          <el-icon>
            <HomeFilled />
          </el-icon>
      ...
      <el-header height="64px">
        <div class="header-content">
          ...
          <div class="header-right">
            <el-button class="dashboard-btn" @click="openDashboard">
              <el-icon>
                <DataLine />
              </el-icon>
              <template #title>数据大屏</template>
            </el-button>
            <el-button class="help-btn" @click="openHelp">
              <el-icon>
                <QuestionFilled />
              </el-icon>
              帮助
...
.logo-img {
  ...
  margin-right: 16px;
  filter:
    drop-shadow(0 2px 4px rgba(0, 0, 0, 0.2)) drop-shadow(0 0 8px rgba(255, 138, 101, 0.3));
...
.logo-img:hover {
  ...
  filter:
    drop-shadow(0 4px 8px rgba(0, 0, 0, 0.3)) drop-shadow(0 0 12px rgba(255, 138, 101, 0.5));
}
...
.help-btn {
  ...
  position: relative;
  overflow: hidden;
  margin-left: 0 !important; /* 强制移除Element Plus的默认左外边距 */
}
