...
import { HomeFilled, DataLine, VideoCamera, Fold, Expand, Picture, VideoPlay, Monitor, Setting, UserFilled, Lock } from '@element-plus/icons-vue'
...
const showLogin = computed(() => {
  ...
  console.log("当前登录状态:", hasToken ? '已登录' : '未登录')
  return !hasToken
})
