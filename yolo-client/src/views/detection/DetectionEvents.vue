<template>
  <div class="detection-events-page">
    ...
    <el-card class="filter-section">
      ...
      <el-form :model="filterForm" inline>
        <el-form-item label="设备">
          <el-select v-model="filterForm.device_id" placeholder="选择设备" style="width: 200px" clearable>
    ...
    <!-- 事件详情模态框 -->
    <el-dialog v-model="eventModalVisible" :title="`事件详情 - ${selectedEvent?.event_type || ''}`" width="800px"
      destroy-on-close>
      <template v-if="selectedEvent">
        <div class="event-detail">
          <div class="event-image">
            <img :src="selectedEventThumbnail" alt="事件图片" class="main-image"
          ...
          <div class="event-info">
            <el-descriptions :column="1">
              ...
              <el-descriptions-item label="状态">
                <el-select v-model="selectedEvent.status" style="width: 100%"
            ...
            <div class="event-actions">
              <el-space>
                <el-button type="primary" @click="showImagePreview(selectedEvent.event_id)">
                  查看原图
                </el-button>
                <el-button type="primary" v-if="hasVideo(selectedEvent)" @click="playVideo(selectedEvent)">
                  播放视频
                </el-button>
                <el-button type="default" @click="downloadEvent(selectedEvent)">
                  下载证据
                </el-button>
              </el-space>
            </div>
    ...
    <!-- 图片预览 -->
    <el-dialog v-model="imagePreviewVisible" fullscreen destroy-on-close :modal="true">
      <div style="display: flex; justify-content: center; align-items: center; max-height: 90vh; overflow: hidden;"
        @wheel="handleWheel" @mousedown="startDrag" @mouseup="stopDrag" @mousemove="drag">
        <img :src="previewImageUrl" alt="预览图片" :style="imageStyle" />
      </div>
    </el-dialog>
  </div>
</template>
